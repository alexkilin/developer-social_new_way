...
@Component("getVideoSortedByViews")
public class PaginationGetVideosSortedByViewsDaoImpl  implements PaginationDao<VideoDto> {
    @PersistenceContext
    private EntityManager entityManager;

    @Override
    public List<? extends VideoDto> getItems(Map<String, Object> parameters) {
        ...
        return entityManager.createQuery(
                "SELECT new com.javamentor.developer.social.platform.models.dto.media.video.VideoDto(v.id," +
                        ...
                        "ORDER BY v.view DESC", VideoDto.class)
